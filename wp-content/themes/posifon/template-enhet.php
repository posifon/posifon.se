    ...
    <main class="wrap960" role="main">
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
          <div class="center">
            <?php
              ...
              <h1><?php echo $post_type->label; ?></h1>
              <p>
                    ...
                    <?php if ($background = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'medium', false, '' )) : ?>
                      ...
                      <?php ; endif; ?>
                        <div class="margin center">
                          ...
                          <p><a class="button" href="#<?php the_title(); ?>">Jag vill veta mer!</a></p>
                        </div>
                  </div>
                </div>
      ...
      // START OF LOOP ?>
          <section id="<?php echo $title = get_the_title(); ?>" class="blank">
            ...
            <p style="text-align: right"><a href="<?php echo get_permalink(378); ?>">Beställ en <?php the_title(); ?> nu >></a></p>
          </section>
          <?php endwhile; endif; wp_reset_query();
      // END OF LOOP ?>
    </main>
