<?php
/**
 * Template Name: Kunskapsbank_eng
 * Created by:
...
<?php 
  ...
  <div class="center">
    <h2>Research, reports and guidelines </h2>
    <p>Here you will find research reports, analyses and guidelines that have been created in cooperation with Posifon. </p>
  </div>
      ...
      <div class="kunskap-text">
        <?php
          ...
          if ($the_link_text = get_field($the_link)) { ?>
            <p>Source: <a href="<?php echo $the_link_text; ?>"><?php echo $the_link_text; ?></a></p>
          <?php }
        ?>
      </div>
    </div>
...
<?php 
  ...
  <div class="center">
    ...
    <p>In this section you can read frequently asked questions and answers to them. Please feel free to contact us if you have a question that is not presented in this section.</p>
  </div>
