        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
          <div class="center">
            <?php
              ...
              <h1>Vilka är vi?</h1>
              <p>
                <?php echo "Posifon AB is an IT / telecom company, based on app and mobile phone technology, offers advanced services for increased security and quality of life. We are an innovative and customer-oriented company based in Gothenburg, Sweden!" ?>
              </p>
